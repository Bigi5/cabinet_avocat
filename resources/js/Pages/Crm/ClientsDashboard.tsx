...
const ClientDashboard = ({ client, stats }: ClientDashboardProps) => {
  return (
    <ClientLayout>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <StatCard 
          ...
          icon={<FolderOpen className="h-5 w-5 text-[#B08D57]" />}
        />
        <StatCard 
          title="Documents"
          value={stats.documents}
          icon={<FileText className="h-5 w-5 text-[#B08D57]" />}
        />
        <StatCard 
          title="Rendez-vous"
          value={stats.rendez_vous}
          icon={<Calendar className="h-5 w-5 text-[#B08D57]" />}
        />
        <StatCard 
          title="Messages"
          value="3"
          icon={<MessageSquare className="h-5 w-5 text-[#B08D57]" />}
        />
      </div>
