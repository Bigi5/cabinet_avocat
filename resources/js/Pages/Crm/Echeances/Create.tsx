// resources/js/Pages/Crm/Echeances/Create.tsx
...
const Create = ({ auth, options, preselected }: CreateProps) => {
  ...
  const validateForm = (): boolean => {
    ...
    const now = new Date();
    if (selectedDate < now) {
      alert('La date de l\'échéance ne peut pas être dans le passé.');
      return false;
    }
  ...
  return (
    <CrmLayout title="Nouvelle échéance">
      <Head title="Nouvelle échéance" />
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-500 font-light">
                Créez une nouvelle échéance ou rappel
              </p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} autoComplete="off">
          ...
          <div className="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
            ...
            >
              ...
              {processing ? 'Enregistrement...' : 'Créer l\'échéance'}
            </button>
          </div>
        </form>
      </div>
