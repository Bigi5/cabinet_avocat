// resources/js/Pages/Crm/Utilisateurs/Create.tsx
...
const Create = ({ auth, options }: CreateProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    post('/crm/utilisateurs');
  };

  return (
    <CrmLayout title="Nouvel utilisateur">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-3xl font-light text-gray-900 mb-2 tracking-tight">Nouvel utilisateur</h1>
              <p className="text-gray-500 font-light">Ajoutez un nouvel utilisateur au CRM</p>
            </div>
          </div>
        </div>
      </div>
