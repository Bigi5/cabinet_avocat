// resources/js/Pages/Crm/Clients/Create.tsx
...
const Create = ({ auth }: CreateProps) => {
  ...
  return (
    <CrmLayout title="Nouveau client">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-3xl font-light text-gray-900 mb-2 tracking-tight">Nouveau client</h1>
              <p className="text-gray-500 font-light">Ajoutez un nouveau client au cabinet</p>
            </div>
          </div>
        </div>
      </div>
