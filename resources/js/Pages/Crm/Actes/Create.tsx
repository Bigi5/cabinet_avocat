// resources/js/Pages/Crm/Actes/Create.tsx
import React from 'react';
import { Head, Link, useForm } from '@inertiajs/react';
import CrmLayout from '@/Layouts/CrmLayout';
import { ArrowLeft, Save, FileText, Folder, User } from 'lucide-react';
...
const Create = ({ auth, options, preselected }: CreateProps) => {
  ...
  return (
    <CrmLayout title="Nouvel acte">
      <Head title="Nouvel acte" />
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-3xl font-light text-gray-900 mb-2 tracking-tight">Nouvel acte</h1>
              <p className="text-gray-500 font-light">Créez un nouvel acte juridique</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
            ...
            >
              ...
              {processing ? 'Création...' : 'Créer l\'acte'}
            </button>
          </div>
        </form>
      </div>
