// resources/js/Pages/Crm/Baux/Create.tsx
...
const Create = ({ auth, options }: CreateProps) => {
  ...
  const generateReference = () => {
    ...
    setData('reference', `BAIL-${year}-${random}`);
  };

  return (
    <CrmLayout title="Nouveau bail">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-3xl font-light text-gray-900 mb-2 tracking-tight">Nouveau bail</h1>
              <p className="text-gray-500 font-light">Créez un nouveau contrat de location</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        <form onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="flex space-x-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#B08D57]/20 focus:border-[#B08D57] transition-all"
                    placeholder="BAIL-2025-0001"
                  />
                  <button
                    type="button"
          ...
          <div className="mb-8 pb-6 border-b border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Locataire - Utilise options.locataires */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Locataire
                </label>
              ...
              {/* Bailleur - Utilise options.bailleurs */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div className="mt-4 text-sm text-gray-500 flex items-center">
              ...
              Si la personne n'est pas dans la liste, ajoutez-la d'abord dans le module Clients.
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Description / Clauses particulières
              </label>
              <textarea
          ...
          <div className="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
            ...
            >
              ...
              {processing ? 'Création...' : 'Créer le bail'}
            </button>
          </div>
        </form>
      </div>
