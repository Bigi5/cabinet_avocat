// resources/js/Pages/services/Professionnels.tsx
  ...
  const services = [
    {
      ...
      title: "Signification Rapide des Actes de Procédure",
      text: "Transmission légale et sécurisée des actes judiciaires et extrajudiciaires entre professionnels. Monopole des huissiers - Article 5 décret 2006-422. Délai : 24-48 heures."
    },
    {
      image: "https://images.unsplash.com/photo-1551135049-8a33b2f5c0f9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      title: "Constat d'Occupation Illicite ou Trouble de Possession",
      text: "Preuves matérielles pour les litiges immobiliers, successions et conflits de possession. Constations matérielles - Valeur probante renforcée. Délai : sous 72 heures."
    },
    {
      image: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      title: "Apposition et Levée de Scellés",
      text: "Mesures conservatoires sur décision judiciaire pour successions, litiges ou sauvegarde de preuves. Officier public - Pouvoir de scellés. Délai : urgence 24h, standard 48-72h."
    },
    {
      image: "https://images.unsplash.com/photo-1560185127-6ed189bf02f4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      title: "Notification Entre Avocats",
      text: "Transmission sécurisée des conclusions, mémoires et pièces dans le cadre des instances. Secret professionnel - Article 5 décret 2006-422. Délai : 24 heures."
    },
    {
      image: "https://images.unsplash.com/photo-1589652717521-10c0d092dea9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      title: "Transmission d'Actes aux Greffes",
      text: "Dépôt formel des actes et décisions auprès des greffes des tribunaux. Formalité légale obligatoire. Délai : 24-48 heures."
    },
    {
      image: "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      title: "Assistance aux Mesures d'Instruction",
      text: "Support technique dans la mise en œuvre des mesures ordonnées par le juge. Auxiliaire de justice - Article 5. Délai : selon ordonnance du juge."
    }
  ];
      ...
      <div className="min-h-screen">
        ...
        <section className="relative bg-gradient-to-br from-[#0B2A4A] via-[#1a3a5f] to-[#0B2A4A] text-white py-24">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-4xl lg:text-5xl font-serif font-bold mb-6">Services pour les Professionnels du Droit</h1>
            <p className="text-xl text-white/90 max-w-2xl">L'expertise procédurale au service de votre pratique - Partenaire des auxiliaires de justice</p>
          </div>
        </section>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow-xl p-8">
                ...
                <div className="space-y-6">
                  {[
                    ...
                    { title: "Services Pour Les Professionnels", icon: Scale, link: "/services/professionnels", active: true },
