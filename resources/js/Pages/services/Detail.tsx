// resources/js/Pages/services/Detail.tsx
import React from 'react';
import { Link } from '@inertiajs/react';
import AppLayout from '../../Layouts/AppLayout';
import { 
  ArrowLeft, CheckCircle, Users, Building, Scale, 
  FileSearch, PhoneCall, Mail, MapPin, ChevronRight 
} from "lucide-react";
      ...
      <div className="min-h-screen">
        ...
        <section className="relative bg-gradient-to-br from-[#0B2A4A] via-[#1a3a5f] to-[#0B2A4A] text-white py-24">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-xl text-white/90 max-w-2xl">Un accompagnement juridique personnalisé pour protéger vos droits</p>
          </div>
        </section>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-12">
              <div className="overflow-hidden rounded-2xl shadow-2xl">
                <img src="https://images.unsplash.com/photo-1589829545856-d10d557cf95f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" alt="Services particuliers" className="w-full h-[400px] object-cover" />
              </div>

              <div className="space-y-8">
                <h2 className="text-3xl font-serif font-bold text-[#0B2A4A]">Recouvrement de créances</h2>
                ...
                <div className="pt-8 border-t border-gray-200">
                  <h3 className="text-2xl font-serif font-bold text-[#0B2A4A] mb-6">Constat d'adultère ou de comportement</h3>
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="overflow-hidden rounded-xl shadow-lg">
                      <img src="https://images.unsplash.com/photo-1551135049-8a33b2f5c0f9?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Constat" className="w-full h-64 object-cover" />
                    </div>
